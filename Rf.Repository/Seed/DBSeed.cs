//using Rf.CommonCommon.DB;
//using Rf.CommonCommon.Extensions;
//using Rf.CommonCommon.Helper;
//using Rf.CommonModel.Models;
//using Rf.CommonModel.Tenants;
...
//                var referencedAssemblies = System.IO.Directory.GetFiles(path, "Rf.CommonModel.dll")
//                   .Select(Assembly.LoadFrom).ToArray();
//                var modelTypes = referencedAssemblies
//                   .SelectMany(a => a.DefinedTypes)
//                   .Select(type => type.AsType())
//                   .Where(x => x.IsClass && x.Namespace is "Rf.CommonModel.Models")
...
//               .SelectMany(a => a.DefinedTypes)
//               .Select(type => type.AsType())
//               .Where(x => x.IsClass && x.Namespace != null && x.Namespace.StartsWith("Rf.CommonModel.Logs"))
//               .ToList();
