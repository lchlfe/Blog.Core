...
namespace Rf.CommonCommon.Seed
{
    public class FrameSeed
    {
        ...
        {
            Create_Controller_ClassFileByDBTalbe(sqlSugarClient, ConnId, $@"C:\my-file\Rf.CommonApi.Controllers", "Rf.CommonApi.Controllers", tableNames, "", isMuti);
            return true;
        }
        ...
        {
            Create_Model_ClassFileByDBTalbe(sqlSugarClient, ConnId, $@"C:\my-file\Rf.CommonModel", "Rf.CommonModel.Models", tableNames, "", isMuti);
            return true;
        }
        ...
        {
            Create_IRepository_ClassFileByDBTalbe(sqlSugarClient, ConnId, $@"C:\my-file\Rf.CommonIRepository", "Rf.CommonIRepository", tableNames, "", isMuti);
            return true;
        }
        ...
        {
            Create_IServices_ClassFileByDBTalbe(sqlSugarClient, ConnId, $@"C:\my-file\Rf.CommonIServices", "Rf.CommonIServices", tableNames, "", isMuti);
            return true;
        }
        ...
        {
            Create_Repository_ClassFileByDBTalbe(sqlSugarClient, ConnId, $@"C:\my-file\Rf.CommonRepository", "Rf.CommonRepository", tableNames, "", isMuti);
            return true;
        }
        ...
        {
            Create_Services_ClassFileByDBTalbe(sqlSugarClient, ConnId, $@"C:\my-file\Rf.CommonServices", "Rf.CommonServices", tableNames, "", isMuti);
            return true;
        }
...
@"using Rf.CommonIServices;
using Rf.CommonModel;
using Rf.CommonModel.Models;
...
@"{SugarColumn}
            ...
            )
        {
            ...
            var ls = IDbFirst.IsCreateDefaultValue().IsCreateAttribute()
                 ...
                 .SettingClassTemplate(p => p =
@"using Rf.CommonIRepository.Base;
using Rf.CommonModel.Models" + (isMuti ? "." + ConnId + "" : "") + @";
    ...
    public interface I{ClassName}Services :IBaseServices<{ClassName}>" + (string.IsNullOrEmpty(strInterface) ? "" : (" , " + strInterface)) + @"
	{
          ...
          bool isMuti = false)
        {
            ...
            var ls = IDbFirst.IsCreateDefaultValue().IsCreateAttribute()
                  ...
                  .SettingClassTemplate(p => p =
@"using Rf.CommonIRepository" + (isMuti ? "." + ConnId + "" : "") + @";
using Rf.CommonIRepository.UnitOfWork;
using Rf.CommonModel.Models" + (isMuti ? "." + ConnId + "" : "") + @";
using Rf.CommonRepository.Base;
    ...
    public class {ClassName}Repository : BaseRepository<{ClassName}>, I{ClassName}Repository" + (string.IsNullOrEmpty(strInterface) ? "" : (" , " + strInterface)) + @"
    {
          ...
          bool isMuti = false)
        {
            ...
            var ls = IDbFirst.IsCreateDefaultValue().IsCreateAttribute()
                  ...
                  .SettingClassTemplate(p => p =
@"
using Rf.CommonIServices" + (isMuti ? "." + ConnId + "" : "") + @";
using Rf.CommonModel.Models" + (isMuti ? "." + ConnId + "" : "") + @";
using Rf.CommonServices.BASE;
using Rf.CommonIRepository.Base;
